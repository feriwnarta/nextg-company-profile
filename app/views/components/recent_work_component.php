    ...
    <div class="row">
        <div class="col-sm-5 offset-sm-1">
            <div class="row d-sm-flex flex-sm-column">
                <div class="col-sm-12">
                    <img src="public/assets/img/sinar-mutiara-web-erp.png" class="img-fluid" alt="sinar mutiara web erp">
                ...
                <div class="col-sm-12 margin-top-40">
                    <img src="public/assets/img/bgm-pik-house-management.png" class="img-fluid" alt="sinar mutiara web erp">
        ...
        <div class="col col-sm-5">
            <div class="row d-sm-flex flex-sm-column">
                <div class="col-sm-12">
                    <img src="public/assets/img/tru-color.png" class="img-fluid" alt="sinar mutiara web erp">
                ...
                <div class="col-sm-12 margin-top-40">
                    <img src="public/assets/img/bgm-pik.png" class="img-fluid" alt="sinar mutiara web erp">
