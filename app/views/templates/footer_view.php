    ...
    <div class="container">
        ...
        <div class="footer-nextg">
            <div class="row">
                <div class="col">
                    <div>
                        <img src="public/assets/img/Logo.png" alt="" width="86px" height="40px">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="d-flex flex-row align-items-center margin-top-20">
                        <img src="public/assets/img/mail.png" alt="" width="16px" height="16px">
                    ...
                    <div class="d-flex flex-row align-items-center margin-top-16">
                        <img src="public/assets/img/phone.png" alt="" width="16px" height="16px">
                ...
                <div class="col">
                    ...
                    <div class="d-flex flex-row align-items-center margin-top-20">
                        <img src="public/assets/img/instagram.png" alt="" width="16px" height="16px">
